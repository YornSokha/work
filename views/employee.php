...
if ($form_state == "create_employee") { ?>
    <form action="EmployeeController.php" name="form_create" id="form_create" method="post">
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="employee_name"
                           value="<?php echo isset($_POST["employee_name"]) ? htmlentities($_POST['employee_name']) : '' ?>"></td>
            </tr>
            <tr>
                <td>Surname:</td>
                <td><input type="text" name="employee_surname"
                           value="<?php echo isset($_POST["employee_surname"]) ? htmlentities($_POST['employee_surname']) : '' ?>">
                </td>
            </tr>
            <tr>
                <td>Telephone:</td>
                <td><input type="text" name="employee_telephone"
                           value="<?php echo isset($_POST["employee_telephone"]) ? htmlentities($_POST['employee_telephone']) : '' ?>">
                </td>
            </tr>
            </tr>
            <tr>
                <td>Salary:</td>
                <td><input type="text" name="employee_salary"
                           value="<?php echo isset($_POST["employee_salary"]) ? htmlentities($_POST['employee_salary']) : '' ?>"></td>
            </tr>
            </tbody>
        </table>
        ...
        <button type="submit" onclick="goto_modify_page_by_id(<?php echo htmlentities($company_id) ?>, 1, 'form_create')"
                name="btn_return" value="return">Return
        </button>
    </form>
<?php } elseif ($form_state = "edit_employee") { ?>
    <form action="EmployeeController.php" name="form_edit" id="form_edit" method="post">
        ...
        <button type="submit" name="btn_register" value="register">Register</button>
        <button type="submit" onclick="goto_modify_page_by_id(<?php echo htmlentities($company_id) ?>, 1, 'form_edit')"
                name="btn_return" value="return">Return
        </button>
    </form>
<?php } ?>
